...
#reduced model 8
cp_red8<- coxph(Surv(time_d,censor_d)~.-time -censor -txgrp -ivdrug -priorzdv -raceth -strat2 -hemophil -sex -id -age, data=aids)
cp_red8$loglik
cp_red8
