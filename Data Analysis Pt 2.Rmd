...
#reduced model 8
cph_r8 <- coxph(Surv(time,censor)~.-priorzdv -id -hemophil -raceth -time_d -strat2 -sex -txgrp -age, data = aids)
cph_r8$loglik
cph_r8
...
#reduced model 9
cph_r9 <- coxph(Surv(time,censor)~.-priorzdv -id -hemophil -raceth -time_d -strat2 -sex -txgrp -age -tx, data = aids)
cph_r9$loglik
cph_r9
