...
ggsurvplot(fit2,data = aids,conf.int = FALSE) + ggtitle("Race/Ethnicity")

fit3 <- survfit(Surv(time,censor)~ivdrug, data = aids)
ggsurvplot(fit3,data = aids,conf.int = FALSE) + ggtitle("IV Drug Use History")
